        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-medium leading-relaxed">
              Високоточне 3D сканування об&apos;єктів будь-якої складності для створення цифрових копій
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <AnimatedSection>
              <p className="text-gray-medium text-lg leading-relaxed">
                Послуга 3D сканування дозволяє створити точну цифрову копію фізичного об&apos;єкта. 
                Використовуємо професійне обладнання для забезпечення високої точності та деталізації.
              </p>
            </AnimatedSection>
