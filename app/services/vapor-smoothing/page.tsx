...
export const metadata: Metadata = {
  ...
  description: "Хімічне згладжування поверхні 3D друкованих деталей для досягнення гладкої поверхні.",
};
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-medium leading-relaxed">
              Хімічне згладжування поверхні для досягнення гладкої, майже дзеркальної поверхні
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <AnimatedSection>
              <p className="text-gray-medium text-lg leading-relaxed">
                Згладжування парою - це процес хімічної обробки 3D друкованих деталей для покращення 
                якості поверхні. Метод дозволяє усунути видимі шари друку та досягти гладкої поверхні.
              </p>
            </AnimatedSection>
