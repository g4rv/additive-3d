...
export const metadata: Metadata = {
  title: "Матеріали - A3D",
  description: "Широкий вибір високоякісних матеріалів для 3D друку: PA12 (MJF), ASA, ABS-PC, ULTEM 9085, PC (FDM).",
};
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-medium leading-relaxed">
              Використовуємо тільки сертифіковані матеріали від провідних виробників для забезпечення 
              найвищої якості та надійності ваших деталей
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <AnimatedSection>
            <div className="mb-12">
              ...
              <p className="text-gray-medium max-w-3xl">
                Технологія HP Multi Jet Fusion забезпечує високу точність та чудові механічні властивості. 
                Ідеально підходить для функціональних деталей та серійного виробництва.
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection>
            <div className="mb-12">
              ...
              <p className="text-gray-medium max-w-3xl">
                Широкий вибір інженерних термопластиків для різних застосувань - від прототипування 
                до виробництва функціональних деталей з особливими властивостями.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <AnimatedSection delay={0.1}>
              <div className="bg-card-bg border border-border rounded-lg p-6 h-full">
                ...
                <h3 className="text-xl font-semibold text-gold mb-3">Призначення</h3>
                <p className="text-gray-medium text-sm">
                  Визначте, для чого буде використовуватися деталь: прототип, функціональна деталь, 
                  оснастка чи кінцевий виріб
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <div className="bg-card-bg border border-border rounded-lg p-6 h-full">
                ...
                <h3 className="text-xl font-semibold text-gold mb-3">Умови експлуатації</h3>
                <p className="text-gray-medium text-sm">
                  Врахуйте температуру, вологість, хімічне середовище та механічні навантаження
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
              <div className="bg-card-bg border border-border rounded-lg p-6 h-full">
                <div className="text-4xl mb-4">💡</div>
                <h3 className="text-xl font-semibold text-gold mb-3">Консультація</h3>
                <p className="text-gray-medium text-sm">
                  Не впевнені? Зв&apos;яжіться з нами - ми допоможемо підібрати оптимальний матеріал
                </p>
              </div>
            </AnimatedSection>
          </div>
